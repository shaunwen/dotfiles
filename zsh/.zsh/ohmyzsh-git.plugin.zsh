...
# This local copy keeps the git aliases/functions available without loading the
# full Oh My Zsh framework.

# Minimal helper from Oh My Zsh lib/git.zsh. The git plugin aliases call this
# directly, but the helper does not live in the plugin upstream.
